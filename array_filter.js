...
//
// Iterate over the elements of arr and return a new array of all elements the
// predicate function returns truthy for. The predicate function is invoked with one argument.
//
// element (anything)
//
// For example:
...
function filter(arr, callback) {
  ...
  for (var i = 0; i < arr.length; i++) {
    truthyArray.push(predicate(arr[i]));
  }
  return truthyArray;
}
